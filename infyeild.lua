...
SettingsButton.Image = "rbxassetid://1"
...
ReferenceButton.Image = "rbxassetid://1"
...
ColorsButton = makeSettingsButton("Edit Theme","rbxassetid://1")
ColorsButton.Position = UDim2.new(0, 5, 0, 55)
ColorsButton.Size = UDim2.new(1, -10, 0, 25)
ColorsButton.Name = "Colors"
ColorsButton.Parent = SettingsHolder

Keybinds = makeSettingsButton("Edit Keybinds","rbxassetid://1")
Keybinds.Position = UDim2.new(0, 5, 0, 85)
Keybinds.Size = UDim2.new(1, -10, 0, 25)
Keybinds.Name = "Keybinds"
Keybinds.Parent = SettingsHolder

Aliases = makeSettingsButton("Edit Aliases","rbxassetid://1")
...
Positions = makeSettingsButton("Edit/Goto Waypoints","rbxassetid://1")
Positions.Position = UDim2.new(0, 5, 0, 145)
Positions.Size = UDim2.new(1, -10, 0, 25)
Positions.Name = "Waypoints"
Positions.Parent = SettingsHolder

EventBind = makeSettingsButton("Edit Event Binds","rbxassetid://1",759)
EventBind.Position = UDim2.new(0, 5, 0, 205)
EventBind.Size = UDim2.new(1, -10, 0, 25)
EventBind.Name = "EventBinds"
EventBind.Parent = SettingsHolder

Plugins = makeSettingsButton("Manage Plugins","rbxassetid://1",743)
...
ExitImage_2.Image = "rbxassetid://1"
...
ExitImage_3.Image = "rbxassetid://1"
...
ExitImage_5.Image = "rbxassetid://1"
...
ImageLabel_2.Image = "rbxassetid://1"
...
eventEditor = (function()
	...
	local main = create({
		...
		{5,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image="rbxassetid://1",Parent={4},Position=UDim2.new(0,5,0,5),Size=UDim2.new(0,10,0,10),ZIndex=10,}},
		...
		{53,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image="rbxassetid://1",Parent={52},Position=UDim2.new(0,2,0,2),Size=UDim2.new(0,16,0,16),ZIndex=10,}},
	})
	main.Name = randomString()
...
ColorsButton.MouseButton1Click:Connect(function()
	...
	if not colorpickerOpen then
		...
		picker = game:GetObjects("rbxassetid://1")[1]
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/getscript-vn/Script/refs/heads/main/infyeild.lua'))()")
	end
end)
...
addcmd('olddex', {'odex'}, function(args, speaker)
	...
	local Dex = getobjects("rbxassetid://1")[1]
	Dex.Parent = PARENT
...
addcmd("bang", {"rape"}, function(args, speaker)
	...
	bangAnim.AnimationId = not r15(speaker) and "rbxassetid://1" or "rbxassetid://1"
...
addcmd('carpet',{},function(args, speaker)
	if not r15(speaker) then
		...
		for i,v in pairs(players)do
			...
			carpetAnim.AnimationId = "rbxassetid://1"
...
addcmd("jerk", {}, function(args, speaker)
    ...
    while task.wait() do
        ...
        if not track then
            local anim = Instance.new("Animation")
            anim.AnimationId = not isR15 and "rbxassetid://1" or "rbxassetid://1"
